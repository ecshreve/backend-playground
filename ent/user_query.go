...
func (uq *UserQuery) QueryTodos() *TodoQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, user.TodosTable, user.TodosPrimaryKey...),
		)
...
func (uq *UserQuery) loadTodos(ctx context.Context, query *TodoQuery, nodes []*User, init func(*User), assign func(*User, *Todo)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.TodosTable)
		s.Join(joinT).On(s.C(todo.FieldID), joinT.C(user.TodosPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(user.TodosPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.TodosPrimaryKey[1]))
